...
// Ganti @session_start() dengan pengecekan yang benar
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Cahyohartono</a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="?pages=informasi" class="nav-link">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item has-treeview">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="?pages=pengguna_admin" class="nav-link">
                      <i class="far fa-dot-circle nav-icon"></i>
                      <p>Admin</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="?pages=pengguna_kasir" class="nav-link">
                      <i class="far fa-dot-circle nav-icon"></i>
                      <p>Kasir</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="?pages=pengguna_dokter" class="nav-link">
                      <i class="far fa-dot-circle nav-icon"></i>
                      <p>Dokter</p>
                    </a>
                  </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="../pages/master/login.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Login</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="../pages/master/register.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Register</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="?pages=tabel" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Tabel</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="?pages=form" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Form</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="?pages=form_edit" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Form Edit</p>
                </a>
              </li>
